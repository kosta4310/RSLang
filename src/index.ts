...
const wordId2 = '5e9f5ee35eb9e72bc21af70f';
...
// api.createUserWord(userId, wordId2, token, { difficulty: 'easy', optional: { repeat: 'false' } }).then((res) =>
//     console.log(res)
// );
...
// api.getUserAggWordById(userId, '5e9f5ee35eb9e72bc21af75e', token).then(res => console.log(res));

// api.upsertStatistics(userId, token, { learnedWords: '5', optional: { time: '545453495' } }).then(res => console.log(res));

// api.getStatistics(userId, token).then(res => console.log(res));
